...
const getDetailMonthlyData = async (initData) => {
    ...
    const detailSelect = {
        "bbs_searchInfo":{
            ...
            "bbs_no":"63","bbs_ordr":"39937","use":"","opCode":"2",
    ...
    const res = await axios.post("https://www.safekorea.go.kr/idsiSFK/bbs/user/selectBbsView.do",detailSelect);
    console.log(res);
    // const detailArray = [];
    // const list = [];
